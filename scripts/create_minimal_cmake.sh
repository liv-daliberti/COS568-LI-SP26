...
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O3 -DNDEBUG -ffast-math -Wall -Wfatal-errors -march=native")
...
# We only include what we need for DynamicPGM, B+Tree, LIPP and the hybrid index
set(BENCH_SOURCES
